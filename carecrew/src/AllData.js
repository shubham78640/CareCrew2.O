...
export const dataDigitalBestSeller = [
  {
    ...
    title: "Housekeeping",
    paragraph:
      "Our housekeepers are trained to keep your homes in order by performing multiple household chores with...",
    category: "Know More",
    linkImg: imgHK,
  ...
  },
  {
    ...
    title: "Cooking",
    paragraph:
      "Our home cooks are professionally trained to prepare wholesome home-style meals for the families to enjoy",
    category: "Know More",
    linkImg: imgcooking,
  ...
  },
  {
    ...
    title: "Child Care",
    paragraph:
      "We provide reliable child caregivers who assure the safety and growth of you child.",
    category: "Know More",
    linkImg: imgCC,
  ...
  },
  {
    ...
    title: "Elder Care",
    paragraph:
      "Whether it's for your parents or grandparents, you can hire trained professionals for taking care of...",
    category: "Know More",
    linkImg: imgEC,
  ...
  },
  {
    ...
    title: "Driving",
    paragraph:
      "We provide licensed drivers with in-depth knowledge about cars and driving etiquette.",
    category: "Know More",
    linkImg: imgDriver,
  ...
  },
  {
    ...
    title: "Others",
    paragraph:
      "Did we miss out on the service you are looking for? Submit your inquiry to us.",
    category: "Know More",
    linkImg: imgOthers,
...
export let CardsData = [
  ...
  },
  {
    ...
    CardContentLines:
      "We provide on-demand services to solve for the challenges you face when your House Help is on leave.",
...
export const skillData = ["HouseKeeping", "Child Care", "Elder Care", "Driving", "Cooking"]
